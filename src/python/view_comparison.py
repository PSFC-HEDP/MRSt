...
filename = "../../output/comparison_high_drifttub_1c_0.001_200_2023-04-18.csv"
CASES = ["005", "016", "017", "015", "001"]
POINTS_TO_SHOW = 150
...
ground_truth_min = ground_truth_max = {
	...
	"001": [1.92e+18, 68.10963735071582,-0.2900906493,3.295152373,14.4519683,6.350179054,0.8569425781,-.778,9.970616694,6.236026801,7.365489006,5.221992371,8.477012035,5.540807458,-82.70139249],
	"005": [4.02e+18, 81.57827724303338,-0.18426077,3.380619635,10.85817745,1.177295346,0.856886018,-.7814462052,8.960380402,3.400291759,6.978207048,4.202804277,7.874669961,4.256110662,-87.44125714],
	"015": [1.92e+18, 100.86974049543558,-0.1588381968,3.168865761,10.47252618,.6080325039,0.856005883,-.7120849961,9.015436804,3.10824185,7.061600627,3.981685591,7.484156813,4.064857076,-93.12940659],
	"016": [3.13e+18, 91.64947774226279,-0.5901396969,4.288099759,9.413961466,1.208433783,0.9520658982,-.7003857988,7.599155994,3.602491165,6.062004003,2.431564928,7.496507264,3.58146492,-58.44907688],
	"017": [2.87e+18, 82.80405354958481,-0.7871359762,4.387469235,7.56604614,-.4128174512,1.20743159,-.5336200009,6.913116212,1.990664254,5.71167482,1.591588135,7.053548379,1.845198033,-43.27693469],
}
# ground_truth_min = {
...
for axes in [
	...
	if len(axes) == 2:
		...
		for i, sim in enumerate(CASES):
			...
			plt.scatter(data[here][x].iloc[:POINTS_TO_SHOW],
			            data[here][y].iloc[:POINTS_TO_SHOW], c=COLORS[i],
